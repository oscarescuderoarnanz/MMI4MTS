...
def load_data(norm, device, split, SG=False, numberOfTimeStep=14):
    ...
    # Load raw data
    X_train = np.load("../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/cmi/split_" + str(split) +
                          "/X_train_tensor_" + str(0)+ ".npy")


    X_val = np.load("../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/cmi/split_" + str(split) +
                        "/X_val_tensor_" + str(0)+ ".npy")
    
    
    X_test = np.load("../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/cmi/split_" + str(split) +
                        "/X_test_tensor.npy")
    

    y_train = pd.read_csv("../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/cmi/split_" + str(split) +
                      "/y_train_" + str(0)+ ".csv",
                     index_col=0)

    y_val = pd.read_csv("../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/cmi/split_" + str(split) +
                    "/y_val_" + str(0)+ ".csv",
                   index_col=0)
    
    y_test = pd.read_csv("../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/cmi/split_" + str(split) + "/y_test.csv",
                            index_col=0)
