...
def load_data(device: torch.device, split: str) -> tuple:
    ...
    """
    # Load static data
    X_train_static = pd.read_csv(f".../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/PFI_MultGNN/5_features/split_{split}/X_train_static_0.csv").drop(['Unnamed: 0'], axis=1)
    X_val_static = pd.read_csv(f"../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/PFI_MultGNN/5_features/split_{split}/X_val_static_0.csv").drop(['Unnamed: 0'], axis=1)
    X_test_static = pd.read_csv(f"../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/PFI_MultGNN/5_features/split_{split}/X_test_static.csv").drop(['Unnamed: 0'], axis=1)

    # Load temporal data
    X_train_temporal = np.load(f"../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/PFI_MultGNN/5_features/split_{split}/X_train_tensor_0.npy")
    X_val_temporal = np.load(f"../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/PFI_MultGNN/5_features/split_{split}/X_val_tensor_0.npy")
    X_test_temporal = np.load(f"../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/PFI_MultGNN/5_features/split_{split}/X_test_tensor.npy")

    # Load labels
    y_train = pd.read_csv(f"../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/PFI_MultGNN/5_features/split_{split}/y_train_0.csv", index_col=0)
    y_val = pd.read_csv(f"../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/PFI_MultGNN/5_features/split_{split}/y_val_0.csv", index_col=0)
    y_test = pd.read_csv(f"../../../../../../../ORIGINAL_DATA/MDR/splits_14_days/PFI_MultGNN/5_features/split_{split}/y_test.csv", index_col=0)
...
class Tester:
    ...
    def test(
        ...
        for folder in folders:
            ...
            S_static = pd.read_csv(f"../../step2_graphRepresentation/{way_to_build_graph}/s{str(int(folder)+1)}/static_graph_Xtr_th_0.15.csv")
